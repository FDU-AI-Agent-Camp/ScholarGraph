"""Keyword-heuristic paradigm classification (Phase G fallback only)."""
...
def classify_heuristic(classifier_input: str) -> ParadigmClassification:
    """Classify using deterministic keyword rules (fallback path only)."""
